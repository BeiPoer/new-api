...
const behaviorSchema = z.object({
  ...
  registerPhoneEnabled: z.boolean(),
  registerPhoneRequired: z.boolean(),
})
...
export function SystemBehaviorSection({
  ...
  const registerPhoneEnabled = form.watch('registerPhoneEnabled')

  const onSubmit = async (data: BehaviorFormValues) => {
    const updates = [
      {
        key: 'DefaultCollapseSidebar',
        value: data.DefaultCollapseSidebar,
        previous: defaultValues.DefaultCollapseSidebar,
      },
      {
        key: 'DemoSiteEnabled',
        value: data.DemoSiteEnabled,
        previous: defaultValues.DemoSiteEnabled,
      },
      {
        key: 'SelfUseModeEnabled',
        value: data.SelfUseModeEnabled,
        previous: defaultValues.SelfUseModeEnabled,
      },
      {
        key: 'general_setting.register_phone_enabled',
        value: data.registerPhoneEnabled,
        previous: defaultValues.registerPhoneEnabled,
      },
      {
        key: 'general_setting.register_phone_required',
        value: data.registerPhoneEnabled && data.registerPhoneRequired,
        previous: defaultValues.registerPhoneRequired,
      },
    ].filter((update) => update.value !== update.previous)
                ...
                <FormControl>
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      if (!checked) {
                        form.setValue('registerPhoneRequired', false, {
                          shouldDirty: true,
                        })
                      }
                    }}
