...
/**
 * Check if payment method is direct enterprise Alipay.
 */
export function isEnterpriseAlipayPayment(paymentType: string): boolean {
  return paymentType === PAYMENT_TYPES.ENTERPRISE_ALIPAY
}
...
export function getDefaultPaymentType(topupInfo: TopupInfo | null): string {
  ...
  if (topupInfo.enable_alipay_topup) {
    return PAYMENT_TYPES.ENTERPRISE_ALIPAY
  }
